...
class NewSessionWidget(SOPSWidget):
    def __init__(self, parent=None):
        ...
        self.enable_end_time = QtWidgets.QCheckBox("Record Behaviour End Time")
        self.back = QtWidgets.QPushButton("Back")
        self.create_session = QtWidgets.QPushButton("Create Session")

        self.enable_end_time.setChecked(False)
        ...
        self.grid_layout.addWidget(self.enable_end_time, 1, 0)
        self.grid_layout.addWidget(self.codeset_label, 2, 0)
        self.grid_layout.addWidget(self.codeset, 2, 1)
        self.grid_layout.addWidget(self.studentset_label, 3, 0)
        self.grid_layout.addWidget(self.studentset, 3, 1)
        self.grid_layout.addWidget(self.media_label, 4, 0)
        self.grid_layout.addWidget(self.media_box, 4, 1)
        self.grid_layout.addWidget(self.media_path, 4, 2)
    ...
    def create_session_clicked(self):
        ...
        temp_session = Session(session_name, code_set=codeset, student_set=studentset, path_media=media_path, end_time_enabled=self.enable_end_time.isChecked())
        temp_session.save()
        self.close()
        self.mainwindow.reset_central_widget()
