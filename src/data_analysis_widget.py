...
class DataAnalysisWidget(SOPSWidget):
    def __init__(self, parent=None, session_name=None):
        ...
        self.max_time = self.data["End Time"].max()
        ...
        self.grid_layout.addWidget(self.canvas, 0, 2, 6, 4)
    ...
    def plot_student_data(self):
        ...
        self.canvas.axes.scatter(selected_data["End Time"], selected_data["Code ID"])
    ...
    def plot_all_data(self):
        ...
        for student in self.unique_students:
            ...
            self.canvas.axes.scatter(temp_data["End Time"], temp_data["Code ID"], c=temp_data["cmap"],
                                     label=student)
